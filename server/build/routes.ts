...
const models: TsoaRoute.Models = {
  ...
  EventOrganizer: {
    ...
    type: {
      ...
      subSchemas: [
        { dataType: "nestedObjectLiteral", nestedProperties: { role: { ref: "EventMemberRole", required: true } } },
        { ref: "MemberField" },
      ],
      validators: {},
    },
  ...
  EventWWMember: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        isVegetarian: { dataType: "boolean", required: true },
        seats: { dataType: "double", required: true },
        car: { dataType: "boolean", required: true },
        departure: { ref: "Departure", required: true },
        arrival: { ref: "Arrival", required: true },
  ...
  EventDto: {
    ...
    type: {
      dataType: "nestedObjectLiteral",
      nestedProperties: {
        wwMembers: { dataType: "array", array: { dataType: "refAlias", ref: "EventWWMember" }, required: true },
        members: { dataType: "array", array: { dataType: "refAlias", ref: "EventMember" }, required: true },
  ...
  Member: {
    ...
    properties: {
      ...
      referencedWorkshops: {
        dataType: "array",
        array: { dataType: "refObject", ref: "WorkshopInstanceHasReferent" },
        required: true,
      },
    },
  ...
  MemberHasEventWw: {
    ...
    properties: {
      ...
      arrival: {
        dataType: "union",
        subSchemas: [
          { dataType: "enum", enums: ["Freitag früh"] },
          { dataType: "enum", enums: ["Freitag vor dem Mittagessen"] },
          { dataType: "enum", enums: ["Freitag vor dem Abendessen"] },
          { dataType: "enum", enums: ["Samstag vor dem Frühstück"] },
          { dataType: "enum", enums: ["Samstag vor dem Mittagessen"] },
          { dataType: "enum", enums: ["Samstag vor dem Abendessen"] },
          { dataType: "enum", enums: ["Samstag spät"] },
          { dataType: "enum", enums: [null] },
        ],
        required: true,
      },
      departure: {
        dataType: "union",
        subSchemas: [
          { dataType: "enum", enums: ["Freitag nach dem Mittagessen"] },
          { dataType: "enum", enums: ["Freitag nach dem Abendessen"] },
          { dataType: "enum", enums: ["Samstag nach dem Frühstück"] },
          { dataType: "enum", enums: ["Samstag nach dem Mittagessen"] },
          { dataType: "enum", enums: ["Samstag nach dem Abendessen"] },
          { dataType: "enum", enums: ["Sonntag"] },
          { dataType: "enum", enums: [null] },
        ],
        required: true,
      },
