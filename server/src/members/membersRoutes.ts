...
router.get("/profile/:id", membersController.retrieveMember);
router.patch("/profile/:id", authController.restrictRoutesSelfOrPermission([1]), membersController.updateMember);
